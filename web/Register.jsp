                                ...
                                <div class="form-group fg">
                                    <div class="col-xs-12">
                                        <div class="input-group">
                                            ...
                                            <input type="email" id="login-password2" name="mail" class="form-control" placeholder="请输入邮箱">
                                        </div>
                                        <small id="hint3"></small>
                                    </div>
                                </div>
                                <div class="">
                                    <button type="submit" class="btn btn-primary btn-lg col-md-10 col-md-push-1 col-sm-12 col-xs-12">注册</button>
                                </div>
                            </form>
                        </div>
                    </div>	
